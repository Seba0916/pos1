...
[Get Postman Collection](https://nacionalcode.org/pos1/public/docs/collection.json)
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/get-attendance/1" \
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/get-attendance/1"
);
...
```bash
curl -X POST \
    "https://nacionalcode.org/pos1/public/connector/api/clock-in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"atque","ip_address":"minima","latitude":"maiores","longitude":"magnam"}'
...
```bash
curl -X POST \
    "https://nacionalcode.org/pos1/public/connector/api/clock-out" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"sit","latitude":"sit","longitude":"est"}'
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/holidays?location_id=aut&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/holidays"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/brand"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/brand/1"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/business-location"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/business-location/1"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=porro&follow_up_type=saepe&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/crm/follow-ups"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/crm/follow-ups/1,2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/crm/follow-ups/1,2"
);
...
```bash
curl -X PUT \
    "https://nacionalcode.org/pos1/public/connector/api/crm/follow-ups/20" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"ut","schedule_type":"neque","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","followup_additional_info":"['call duration' => '1 hour']","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","allow_notification":true}'
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/crm/follow-up-resources" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/crm/follow-up-resources"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=qui&biz_name=tenetur&mobile_num=16&contact_id=nulla&order_by=nulla&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/crm/leads"
);
...
```bash
curl -X POST \
    "https://nacionalcode.org/pos1/public/connector/api/crm/call-logs" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"velit","mobile_name":"possimus","call_type":"call","start_time":"vel","end_time":"commodi","duration":"enim"}]}'
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=officia&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/cash-register"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":14,"initial_amount":822761.1410297,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":312363.0725014,"total_card_slips":15,"total_cheques":8,"closing_note":"magni","transaction_ids":"1,2,3"}'
...
let body = {
    "location_id": 14,
    "initial_amount": 822761.1410297,
    "created_at": "2020-5-7 15:20:22",
    "closed_at": "2020-5-7 15:20:22",
    "status": "close",
    "closing_amount": 312363.0725014,
    "total_card_slips": 15,
    "total_cheques": 8,
    "closing_note": "magni",
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/cash-register/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/cash-register/59"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/contactapi?type=deserunt&name=et&biz_name=non&mobile_num=4&contact_id=necessitatibus&order_by=necessitatibus&direction=sed&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/contactapi"
);
...
let params = {
    ...
    "biz_name": "non",
    "mobile_num": "4",
    "contact_id": "necessitatibus",
    "order_by": "necessitatibus",
    "direction": "sed",
    "per_page": "10",
};
Object.keys(params)
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"ut","prefix":"unde","first_name":"doloremque","middle_name":"eos","last_name":"quia","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"cumque","address_line_2":"autem","city":"quis","state":"ut","country":"molestiae","zip_code":"sint","customer_group_id":"nihil","contact_id":"sit","dob":"2000-06-13","custom_field1":"consequatur","custom_field2":"molestias","custom_field3":"sit","custom_field4":"commodi","email":"non","shipping_address":"ea","position":"nihil","opening_balance":0,"source_id":3,"life_stage_id":2,"assigned_to":[]}'
...
let body = {
    ...
    "address_line_1": "cumque",
    "address_line_2": "autem",
    "city": "quis",
    "state": "ut",
    "country": "molestiae",
    "zip_code": "sint",
    "customer_group_id": "nihil",
    "contact_id": "sit",
    "dob": "2000-06-13",
    "custom_field1": "consequatur",
    "custom_field2": "molestias",
    "custom_field3": "sit",
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/contactapi/1"
);
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"eaque","prefix":"sed","first_name":"mollitia","middle_name":"voluptates","last_name":"velit","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"eum","address_line_2":"earum","city":"est","state":"quis","country":"velit","zip_code":"reprehenderit","customer_group_id":"architecto","contact_id":"sed","dob":"2000-06-13","custom_field1":"velit","custom_field2":"vero","custom_field3":"odio","custom_field4":"odio","email":"autem","shipping_address":"adipisci","position":"temporibus","opening_balance":10.3,"source_id":12,"life_stage_id":2,"assigned_to":[]}'
...
let body = {
    "type": "customer",
    "supplier_business_name": "eaque",
    "prefix": "sed",
    "first_name": "mollitia",
    "middle_name": "voluptates",
    "last_name": "velit",
    ...
    "state": "quis",
    "country": "velit",
    "zip_code": "reprehenderit",
    "customer_group_id": "architecto",
    "contact_id": "sed",
    "dob": "2000-06-13",
    "custom_field1": "velit",
    "custom_field2": "vero",
...
```bash
curl -X POST \
    "https://nacionalcode.org/pos1/public/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":8,"card_number":"debitis","card_holder_name":"rerum","card_transaction_number":"mollitia","card_type":"velit","card_month":"voluptatem","card_year":"iste","card_security":"ipsam","transaction_no_1":"et","transaction_no_2":"officiis","transaction_no_3":"dolorum","cheque_number":"quasi","bank_account_number":"eum","note":"totam"}'
...
let body = {
    ...
    "card_type": "velit",
    "card_month": "voluptatem",
    "card_year": "iste",
    "card_security": "ipsam",
    "transaction_no_1": "et",
    "transaction_no_2": "officiis",
    "transaction_no_3": "dolorum",
    "cheque_number": "quasi",
    "bank_account_number": "eum",
    "note": "totam"
}
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/expense?location_id=et&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=consequatur&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/expense"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":13,"final_total":6716719,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":15,"expense_for":18,"contact_id":4,"additional_notes":"dolor","is_refund":0,"is_recurring":0,"recur_interval":9,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"sed","recur_repetitions":17,"payment":[{"amount":453.13,"method":"cash","account_id":6,"card_number":"et","card_holder_name":"sint","card_transaction_number":"eius","card_type":"enim","card_month":"totam","card_year":"et","card_security":"magni","transaction_no_1":"molestias","transaction_no_2":"excepturi","transaction_no_3":"voluptatem","note":"dicta","cheque_number":"ut"}]}'
    ...
    "payment": [
        {
            ...
            "card_year": "et",
            "card_security": "magni",
            "transaction_no_1": "molestias",
            "transaction_no_2": "excepturi",
            "transaction_no_3": "voluptatem",
            "note": "dicta",
            "cheque_number": "ut"
        }
    ]
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "https://nacionalcode.org/pos1/public/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":241834040.5654,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":15,"expense_for":7,"contact_id":7,"additional_notes":"labore","is_recurring":0,"recur_interval":20,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"dolorem","recur_repetitions":7,"payment":[]}'
...
let body = {
    "final_total": 241834040.5654,
    "transaction_date": "2020-5-7 15:20:22",
    "tax_rate_id": 15,
    "expense_for": 7,
    "contact_id": 7,
    "additional_notes": "labore",
    "is_recurring": 0,
    "recur_interval": 20,
    "recur_interval_type": "months",
    "subscription_repeat_on": 15,
    "subscription_no": "dolorem",
    "recur_repetitions": 7,
    "payment": []
}
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/expense-refund?location_id=veniam&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=explicabo&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/expense-refund"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/product?brand_id=ex&category_id=quisquam&sub_category_id=voluptatum&location_id=in&selling_price_group=sunt&name=recusandae&sku=unde&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/product"
);

let params = {
    "brand_id": "ex",
    "category_id": "quisquam",
    "sub_category_id": "voluptatum",
    "location_id": "in",
    "selling_price_group": "sunt",
    "name": "recusandae",
    "sku": "unde",
    "per_page": "10",
};
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/product/1?selling_price_group=qui" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/product/1"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/variation/?brand_id=voluptatibus&category_id=illo&sub_category_id=soluta&not_for_selling=atque&name=debitis&sku=nihil&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/variation/"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/sell?location_id=fuga&contact_id=itaque&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&user_id=nam&service_staff_id=et&shipping_status=ordered&only_subscriptions=dolor&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/sell"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":5,"contact_id":13,"transaction_date":"2020-07-22 15:48:29","invoice_no":"quas","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":19,"discount_amount":10,"discount_type":"fixed","sale_note":"assumenda","staff_note":"laudantium","commission_agent":19,"shipping_details":"Express Delivery","shipping_address":"non","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":5,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":11,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"deleniti","recur_repetitions":9,"rp_redeemed":7,"rp_redeemed_amount":13.5,"types_of_service_id":1,"service_custom_field_1":"dolorem","service_custom_field_2":"sit","service_custom_field_3":"est","service_custom_field_4":"earum","round_off_amount":405.2193238,"table_id":19,"service_staff_id":17,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":14,"note":"omnis"}],"payments":[{"amount":453.13,"method":"cash","account_id":9,"card_number":"quia","card_holder_name":"voluptas","card_transaction_number":"consequuntur","card_type":"sunt","card_month":"praesentium","card_year":"sapiente","card_security":"vel","transaction_no_1":"dolorum","transaction_no_2":"nobis","transaction_no_3":"distinctio","bank_account_number":"odit","note":"dolor","cheque_number":"quia"}]}]}'
    ...
    "sells": [
        {
            ...
            "recur_interval_type": "months",
            "subscription_repeat_on": 15,
            "subscription_no": "deleniti",
            "recur_repetitions": 9,
            "rp_redeemed": 7,
            "rp_redeemed_amount": 13.5,
            "types_of_service_id": 1,
            "service_custom_field_1": "dolorem",
            "service_custom_field_2": "sit",
            "service_custom_field_3": "est",
            "service_custom_field_4": "earum",
            "round_off_amount": 405.2193238,
            "table_id": 19,
            "service_staff_id": 17,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "card_transaction_number": "consequuntur",
                    "card_type": "sunt",
                    "card_month": "praesentium",
                    "card_year": "sapiente",
                    "card_security": "vel",
                    "transaction_no_1": "dolorum",
                    "transaction_no_2": "nobis",
                    "transaction_no_3": "distinctio",
                    "bank_account_number": "odit",
                    "note": "dolor",
                    "cheque_number": "quia"
                }
            ]
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/sell/55" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/sell/55"
);
...
```bash
curl -X PUT \
    "https://nacionalcode.org/pos1/public/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":5,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":9,"discount_amount":10,"discount_type":"fixed","sale_note":"omnis","staff_note":"praesentium","sells":[{"is_suspend":false}],"commission_agent":10,"shipping_details":"Express Delivery","shipping_address":"ea","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":17,"pay_term_number":1,"pay_term_type":"months","is_recurring":0,"recur_interval":11,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"ut","recur_repetitions":5,"rp_redeemed":3,"rp_redeemed_amount":13.5,"types_of_service_id":16,"service_custom_field_1":"itaque","service_custom_field_2":"molestiae","service_custom_field_3":"odio","service_custom_field_4":"nostrum","round_off_amount":261994452.2,"table_id":4,"service_staff_id":1,"change_return":0,"change_return_id":4,"products":[{"sell_line_id":20,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":5,"discount_amount":0,"discount_type":"percentage","sub_unit_id":15,"note":"id"}],"payments":[{"payment_id":5,"amount":453.13,"method":"cash","account_id":18,"card_number":"veritatis","card_holder_name":"minima","card_transaction_number":"et","card_type":"corporis","card_month":"voluptatum","card_year":"nihil","card_security":"deserunt","transaction_no_1":"at","transaction_no_2":"quia","transaction_no_3":"voluptatem","note":"aut","cheque_number":"omnis","bank_account_number":"consequatur"}]}'
...
let body = {
    ...
    "service_custom_field_2": "molestiae",
    "service_custom_field_3": "odio",
    "service_custom_field_4": "nostrum",
    "round_off_amount": 261994452.2,
    "table_id": 4,
    "service_staff_id": 1,
    "change_return": 0,
    "change_return_id": 4,
    ...
    "payments": [
        {
            ...
            "method": "cash",
            "account_id": 18,
            "card_number": "veritatis",
            "card_holder_name": "minima",
            "card_transaction_number": "et",
            "card_type": "corporis",
            "card_month": "voluptatum",
            "card_year": "nihil",
            "card_security": "deserunt",
            "transaction_no_1": "at",
            "transaction_no_2": "quia",
            "transaction_no_3": "voluptatem",
            "note": "aut",
            "cheque_number": "omnis",
...
```bash
curl -X DELETE \
    "https://nacionalcode.org/pos1/public/connector/api/sell/provident" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "https://nacionalcode.org/pos1/public/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":17,"transaction_date":"2020-5-7 15:20:22","invoice_no":"molestiae","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":14,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "https://nacionalcode.org/pos1/public/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":15,"shipping_status":"ordered","delivered_to":"earum"}'
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/table?location_id=ullam" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/table"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/taxonomy?type=dolore" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/user/loggedin"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/user?service_staff=quod" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/user"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/user/1"
);
...
```bash
curl -X POST \
    "https://nacionalcode.org/pos1/public/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"reprehenderit","new_password":"praesentium"}'
...
let body = {
    "current_password": "reprehenderit",
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/profit-loss-report?location_id=enim&start_date=2018-06-25&end_date=2018-06-25&user_id=aut" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/profit-loss-report"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "https://nacionalcode.org/pos1/public/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://nacionalcode.org/pos1/public/connector/api/notifications"
);
